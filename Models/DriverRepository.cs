    ...
    public class DriverRepository
    {
        public static List<Driver>drivers = new List<Driver> 
        {
             new Driver { imagepath = "/Content/Images/Person1.png" ,Id = 1,Name = "Alice Smith",PhoneNumber = "0712345678", servicetype = "ALS" },
               ...
               new Driver { imagepath = "/Content/Images/Person4.png" ,Id = 4,Name = "Alice",PhoneNumber = "0712345678", servicetype = "SOS" },
               ...
               new Driver { imagepath = "/Content/Images/Person10.png" ,Id = 12,Name = "Alice",PhoneNumber = "0712345678", servicetype = "SOS" },
        };
        public static List<Driver> GetDrivers()
        {
           return new List<Driver> 
           {
               ...
               new Driver { imagepath = "/Content/Images/Person4.png" ,Id = 4,Name = "Thomas Muller",PhoneNumber = "0725467890", servicetype = "SOS" },
               ...
               new Driver { imagepath = "/Content/Images/Person10.png" ,Id = 12,Name = "Denise Mphahlele",PhoneNumber = "0723458796", servicetype = "SOS" },
           };
